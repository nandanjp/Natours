...
var showAlert = function showAlert(type, message) {
  ...
  markup.innerHTML = message; //`<div class="alert alert--${type}">${message}</div>`;

  document.querySelector("body").insertAdjacentElement("afterbegin", markup);
  window.setTimeout(function () {
    return void hideAlert();
  }, 2500);
};
...
exports.logout = exports.default = void 0;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoia3Vqb2ZvcmFsbCIsImEiOiJja2tscm9uNGwxNmdqMnBxbmpsaXJtczltIn0.DAZ-WcI8dkcB3jiHRnO7yg";
  var map = new mapboxgl.Map({
    container: "map",
    //Puts this on an element with the id map
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); //Extend map bounds to include the current locations
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "".concat(type === "password" ? "Password" : "Data", " was Successfully Updated!"));
              window.setTimeout(function () {
                location.assign("/me");
              }, 1500);
            }
...
var loginForm = document.querySelector("form.form.form--login");
...
if (loginForm) addEventListener("submit", /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            //Values
            email = (_document$getElementB2 = document.getElementById("email")) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.value;
            password = (_document$getElementB3 = document.getElementById("password")) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.value;
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            document.querySelector(".btn--save-password").innerHTML = "Save password"; // document.getElementById("password-current")?.value = "";
